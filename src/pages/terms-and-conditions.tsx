        ...
        <CardContent sx={{ padding: 10 }}>
          <Box sx={{ margin: '20px', maxWidth: '1600px' }}>
            ...
            <Typography paragraph>
              ...
              เงื่อนไขและข้อตกลงเหล่านี้กำหนดกฎเกณฑ์และข้อบังคับสำหรับการใช้งานเว็บไซต์ของ LOG21RUBY CO., LTD.
              ซึ่งตั้งอยู่ที่ https://paiduay.com
            </Typography>
            <Typography paragraph>
              การเข้าถึงเว็บไซต์นี้ถือว่าคุณยอมรับเงื่อนไขและข้อตกลงเหล่านี้อย่างเต็มที่
              หากคุณไม่เห็นด้วยกับเงื่อนไขและข้อตกลงทั้งหมดที่ระบุไว้บนหน้านี้ กรุณาอย่าใช้งานเว็บไซต์
              [ชื่อเว็บไซต์ของคุณ
            </Typography>
            ...
            <Typography paragraph>
              ...
              ข้อมูลเหล่านี้จะไม่ถูกเปิดเผยต่อสาธารณะหรือนำไปใช้เพื่อวัตถุประสงค์อื่นๆ
              นอกเหนือจากการให้บริการบนแพลตฟอร์มนี้
            </Typography>
